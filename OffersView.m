...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
          [self setTitle:NSLocalizedString(@"Offers", @"")];
    }
    return self;
}
...
- (void)viewDidLoad
{
    ...
    offers = [clientManger getAllOffers];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OfferModel *offer = (OfferModel *)[offers objectAtIndex:indexPath.row];
    cell.textLabel.text = offer.offer_title;
    cell.detailTextLabel.text = offer.offer_text;
    return cell;
}
